...
export default function GuestProfile({ params }) {
  ...
  const handleStatusChange = async (newStatus) => {
    ...
    if ((newStatus === "checkin" || newStatus === "checkout") && !hasEditPermission) {
          ...
          <div className="col-lg-3 col-md-3 col-sm-12">
            <div className="bg-white rounded-lg p-6 h-100">
              <div className="flex justify-between items-center">
                <h2 className="text-hotel-primary-text text-xl font-[500] ">Profile</h2>
                <FaEllipsisH className="text-gray-400" />
              </div>
              <div className="flex items-center mb-4">
                <div className="w-20 h-20 rounded-full bg-green-200 mr-4 overflow-hidden">
                  <Image 
                    src={`${booking.gender === "male" ? "https://i.pravatar.cc/150?u=a042581f4e29026024d" : "https://i.pravatar.cc/150?u=a092581d4ef9026700d"}`} 
                    width={80} 
                    height={80} 
                    alt="userimg"
                ...
                <div>
                  <h3 className="text-hotel-primary-text text-lg font-semibold">{`${booking.firstName} ${booking.lastName}`}</h3>
              ...
              <div className="mb-4 space-y-3">
                <p className="flex items-center transition-colors hover:bg-gray-50 p-2 rounded">
                  <FaPhone className="w-5 h-5 mr-3 text-blue-500" />
                  <a 
                    href={`tel:${booking.mobileNo}`} 
                    className="text-hotel-primary-text hover:text-blue-600 transition-colors"
                    title="Click to call"
                  >
                    {booking.mobileNo}
                  </a>
              ...
              <div className="border-t pt-4">
                <h4 className="font-[600] mb-2 text-hotel-primary-text">Personal Information</h4>
                <div className="grid grid-cols-1 gap-4 text-sm">
                  {/* Personal Details Section */}
                  <div className="space-y-4">
                    <div className="flex items-start space-x-8">
                      <div className="flex-1">
                        <p className="text-hotel-secondary-grey mb-1">Date of Birth</p>
                    ...
                    <div className="flex items-start space-x-8">
                      <div className="flex-1">
                        <p className="text-hotel-secondary-grey mb-1">Nationality</p>
                        <p className="text-hotel-primary-text font-[500] bg-gray-50 p-2 rounded">
              ...
              <div className="border-t pt-4 mt-4">
                <h4 className="text-hotel-primary-text font-semibold mb-2">ID Proof Information</h4>
                ...
                <div className="row">
                  <div className="col-lg-8 col-md-12 col-sm-12 flex flex-col h-full">
                    <div className="flex justify-between items-center mb-4">
                      <h2 className="text-hotel-primary-text text-xl font-semibold">Booking Info</h2>
                    </div>
                    ...
                    {/* Replace the existing Status Timestamps section with this new one */}
                    <div className="mb-6 p-4 bg-white rounded-lg shadow-sm border">
                      <h4 className="text-lg font-semibold mb-4 text-hotel-primary-text">Booking Timeline</h4>
                      <div className="relative">
                        {booking.statusTimestamps && Object.entries(booking.statusTimestamps)
                          ...
                          .map(([status, timestamp], index, array) => {
                            ...
                            return (
                              <div key={status} className="flex flex-col md:flex-row items-start md:items-center mb-4 relative">
                                {/* Timeline line */}
                                {!isLast && (
                                ...
                                <div className="flex items-center min-w-[150px]">
                                  <div className={`w-8 h-8 rounded-full ${getStatusColor(status)} flex items-center justify-center text-white shadow-md z-10`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Guest</p>
                        <p className="text-hotel-primary-text font-medium">{`${booking.guests.adults} Adults, ${booking.guests.children} Children`}</p>
                      </div>
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Number of Rooms</p>
                        <p className="text-hotel-primary-text font-medium">{booking.numberOfRooms}</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Check In</p>
                      ...
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Check Out</p>
                        <p className="text-hotel-primary-text font-medium">
                      ...
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Duration</p>
                        <p className="text-hotel-primary-text font-medium">
                          {Math.ceil(
                    ...
                    <div className="gap-4 mb-4">
                      <div>
                        <p className="text-sm text-hotel-secondary-grey font-[400]">Notes</p>
                        <p className="text-hotel-primary-text font-medium">
                  ...
                  <div className="col-lg-4 col-md-12 col-sm-12">
                    <div className="bg-gray-100 rounded-lg shadow-md p-6 mt-6">
                      <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl  text-hotel-primary-text font-medium">Room Info</h2>
                      ...
                      <div className="space-y-2 text-sm">
                        {booking.rooms.map((room, index) => {
                          ...
                          const additionalCharge = parseFloat(room.additionalGuestCharge) || 0;
                          const roomTotal = room.totalAmount || (baseTotal + igstTotal + additionalCharge);
                        ...
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              ...
                              <span>₹{booking.totalAmount.roomCharge.toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Total Taxes</span>
                              <span>₹{booking.totalAmount.taxes.toFixed(2)}</span>
                            </div>
                            {booking.totalAmount.additionalGuestCharge > 0 && (
                              <div className="flex justify-between text-blue-600">
                                <span>Total Additional Guest Charges</span>
                                <span>₹{booking.totalAmount.additionalGuestCharge.toFixed(2)}</span>
                              </div>
                            )}
                            <div className="flex justify-between font-medium pt-2 border-t mt-2">
                              <span>Grand Total</span>
                              <span>₹{booking.totalAmount.total.toFixed(2)}</span>
                            </div>
